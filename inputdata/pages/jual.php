...
if (isset($_GET['reset_karyawan'])) {
    unset($_SESSION['id_karyawan']);
    unset($_SESSION['nomor_nota']);
...
<?php if (isset($_SESSION['id_karyawan']) && isset($_SESSION['nomor_nota']) && $_SESSION['id_karyawan'] !== '' && $_SESSION['nomor_nota'] !== ''): ?>
    <div class="card" style="max-width:600px;margin:24px 0 18px 0;">
        ...
        <a href="jual.php?reset_karyawan=1" class="btn btn-neutral" style="margin-left:8px;font-size:0.95em;" onclick="return confirm('Ganti karyawan? Ini akan mereset nota dan cart belanja.')">Ganti Karyawan</a>
    </div>
<?php endif; ?>
