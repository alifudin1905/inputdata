...
<body>
    ...
    exit;
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" class="form-inline">
                                ...
                                <input type="text" name="nama_karyawan" value="<?= htmlspecialchars($k['nama']) ?>" required>
                                <button type="submit" name="edit" class="btn btn-primary">Simpan</button>
                            </form>
                        </td>
                        <td>
                            <a href="karyawan.php?hapus=<?= $k['id'] ?>" onclick="return confirm('Hapus karyawan ini?')" class="btn btn-negative">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <div class="nav-bottom">
            <a href="index.php">Kembali ke Penjualan</a>
        </div>
    </div>
